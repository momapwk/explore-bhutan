...
const Dance=()=> {
  return (   
    <Box maxW="4xl" mx="auto" p={5}>
      ...
      <Image
        src="/src/assets/Image/Dance.jpeg" 
        alt="Bhutan cultural festival"
        borderRadius="md"
        mb={4}
      />
      ...
      <Text fontWeight="semibold" color="pink.500" mb={2} fontSize={'lg'}>
        What's the story
      </Text>
      ...
      <Text mb={3} fontSize={'lg'}>
        <Highlight
          ...
          styles={{ fontWeight: "bold", color: "blue.600" }}
        >
